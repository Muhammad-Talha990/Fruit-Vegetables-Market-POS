...
5. Once complete, click "Finish". The application will automatically launch, and a shortcut will be placed on your Desktop.

Updating:
To upgrade to a newer version, simply run the new Setup file. The installer will automatically update your existing files safely without deleting your database.
