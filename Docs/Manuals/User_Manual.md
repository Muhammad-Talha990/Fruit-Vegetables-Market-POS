...
- **Dashboard:** Provides an overview of daily sales, low stock alerts, and quick actions.

## 3. Core Features
- **Billing:** Fast, barcode-ready checkout process.
- **Products:** Manage your inventory, add new items, and update prices.
- **Customers & Suppliers:** Keep track of ledgers, credit, and outstanding balances.
